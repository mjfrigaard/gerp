...
`ger_path_lkp()` will return the folder tree (or trees) of the provided file or folder to `x`:

```{r ger_path_lkp_dir, eval=FALSE}
...
```{r ger_path_lkp_dirs, eval=FALSE}
# check for README.Rmd files
gerp::ger_path_lkp(x = "README.Rmd")
/Users/mjfrigaard/projects/pkgs/gerp
└── README.Rmd

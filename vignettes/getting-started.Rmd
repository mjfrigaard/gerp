...
After locating the R project folder, you can pass it to `gerp::ger_go()`, and your new 'good enough' project will open in a new session. 

```{r ger_go, eval=FALSE}
gerp::ger_go(parent_dir = "/<Users>/<username>/<folder>", proj_name = "my new project")
```

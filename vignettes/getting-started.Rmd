...
```{r ger_path-home, echo=FALSE, eval=TRUE, out.width='60%', fig.align='center', fig.cap='help for ger_path()'}
knitr::include_graphics("../man/figures/ger_path-home.png")
```

<br>

You can then continue using your mouse (or the arrow keys) to navigate to the folder you want your R project to live in (in my case, it's `/Users/mjfrigaard/projects/`)

<br>

```{r ger_path-gif, echo=FALSE, eval=TRUE, out.width='80%'}

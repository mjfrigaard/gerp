...
#' @export ger_ref
#'
#' @description Create ref folder with ref/notebook.Rmd, ref/manuscript.Rmd,
#'     and changelog.md files.
#' \describe{
#'   \item{ref/notebook.Rmd}{An R Markdown notebook (i.e., lab notebook).}
#'   \item{ref/manuscript.Rmd}{A more polished R Markdown file for reports or manuscripts.}
#'   \item{changelog.md}{Manually document changes to the files or folders in your project.}
#' }
#'
ger_ref <- function(show_file = TRUE) {
  fs::dir_create("ref")
# notebook ----------------------------------------------------------------
  fs::file_create("ref/notebook.Rmd")
  ...
  readr::write_lines(x = notebook_content, file = "ref/notebook.Rmd")
# manuscript --------------------------------------------------------------
  fs::file_create("ref/manuscript.Rmd")
  ...
  readr::write_lines(x = manuscript_content, file = "ref/manuscript.Rmd")
